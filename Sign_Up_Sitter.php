...
$tmp=$_FILES['pic']['tmp_name'];
		...
		$dbemail=$rows['email'];
		if($first_name==null || $last_name==null || $email==null || $password==null || $age==null || $phone_number==null || $ID_number==null || $city==null || empty($gender)) echo "
		<script>
...
$picpath="images/$first_name.$ext";
		...
		echo "
		<script>
			window.alert('Registered Succeffully!');
...
?>
        ...
        <div class="container2">
            ...
            <form action="Sign_Up_Sitter.php" method="post" enctype="multipart/form-data">
                <div class="user-details2">
                    ...
                    <div class="input-box2">
                        ...
                        <input type="text" placeholder="Enter your ID number" name="ID_number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" required>
                    </div>
        
                    <div class="input-box2">
                        <span class="details2">Phone Number</span>
                        <input type="text" placeholder="Enter your Phone number" name="phone_number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" required>
                    </div>

                    <div class="input-box2">
                        <span class="details2">age</span>
                        <input type="text" placeholder="Enter your age" name="age" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" required>
                    </div>
