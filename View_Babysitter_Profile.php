...
?>
    ...
    <form action="View_Babysitter_Profile.php" method="post">
        <div class="user-details">
            ...
            <div class="input-box">
                <span id="details1">ID:</span>
                <span class="details"><?php echo $ID_number; ?></span>
            </div>
            <div class="input-box">
            ...
            <div class="input-box">
                <span id="details1">Age:</span>
                <span class="details"><?php echo $age; ?></span>
            </div>
            <div class="input-box">
 ...
 <span class="details"><?php echo $city; ?></span>
            ...
            <div class="input-box">
                <span id="details1">Gender :</span>
 <span class="details"><?php echo $gender; ?></span>
            </div>
            <div class="input-box">
                <span id="details1">Bio :</span>
 <span class="details"><?php echo $bio; ?></span>
            </div>
